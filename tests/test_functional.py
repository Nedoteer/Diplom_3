...
from pages.functional_page import Functional
...
class TestFunctional:
    ...
    def test_click_constructor(self, driver):
        click_constructor = Functional(driver)
    ...
    def test_igridient(self, driver):
        click_ingridient = Functional(driver)
    ...
    def test_exit_ingridient(self, driver):
        click_exit_ingridient = Functional(driver)
